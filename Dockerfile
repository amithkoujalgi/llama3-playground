...
RUN echo 'mkdir -p /app/data/easyocr-models && cd /app/data/easyocr-models && curl -O https://github.com/JaidedAI/EasyOCR/releases/download/pre-v1.1.6/craft_mlt_25k.zip && unzip craft_mlt_25k.zip && rm craft_mlt_25k.zip && curl -O https://github.com/JaidedAI/EasyOCR/releases/download/v1.3/english_g2.zip && unzip english_g2.zip && rm english_g2.zip' >> /start-services.sh
